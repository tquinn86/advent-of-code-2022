...
The problem is [here](https://adventofcode.com/2022/day/1). I won't reiterate them here (though I will link). Note, each day has two problems that build upon each other. I didn't know that today, so I called the directory `dec-1-1`, thinking there would be a `dec-1-2` but there is not. Answer is [here](dec-1-1/)
